...
VALUES
    (1,'admin','2024-03-19T23:00:17','2024-03-20T23:00:17','事假','','2024-03-19T23:01:40',NULL,NULL,''),
    (4,'admin','2024-03-20T22:10:14','2024-03-21T22:10:14','事假','123','2024-03-20T22:11:24',NULL,NULL,'leave'),
    (7,'admin','2024-03-20T22:40:10','2024-03-21T22:40:10','事假','','2024-03-20T22:48:51',NULL,NULL,'leave2'),
    (8,'admin','2024-03-20T14:40:16','2024-03-21T14:40:16','事假','','2024-03-20T23:40:29',NULL,NULL,'leave3');
...
VALUES
    (1,'用户性别','sys_user_sex','0','admin','2022-05-26T15:25:38',NULL,NULL,'用户性别列表'),
    (2,'菜单状态','sys_show_hide','0','admin','2022-05-26T15:25:38',NULL,NULL,'菜单状态列表'),
    (3,'系统开关','sys_normal_disable','0','admin','2022-05-26T15:25:38',NULL,NULL,'系统开关列表'),
    (4,'任务状态','sys_job_status','0','admin','2022-05-26T15:25:38',NULL,NULL,'任务状态列表'),
    (5,'任务分组','sys_job_group','0','admin','2022-05-26T15:25:38',NULL,NULL,'任务分组列表'),
    (6,'系统是否','sys_yes_no','0','admin','2022-05-26T15:25:38',NULL,NULL,'系统是否列表'),
    (7,'通知类型','sys_notice_type','0','admin','2022-05-26T15:25:38',NULL,NULL,'通知类型列表'),
    (8,'通知状态','sys_notice_status','0','admin','2022-05-26T15:25:38',NULL,NULL,'通知状态列表'),
    (9,'操作类型','sys_oper_type','0','admin','2022-05-26T15:25:38',NULL,NULL,'操作类型列表'),
    (10,'系统状态','sys_common_status','0','admin','2022-05-26T15:25:38',NULL,NULL,'登录状态列表');
...
VALUES
    (1, '系统管理', 0, 4, '#', 'menuItem', 'M', '0', '1', '', 'fa fa-gear', 'admin', '2022-03-31T14:22:06', 'admin', '2022-03-31T15:05:06', '系统管理目录'),
    (3, '系统工具', 0, 6, '#', 'menuItem', 'M', '0', '1', '', 'fa fa-bars', 'admin', '2022-03-31T14:22:06', 'admin', '2022-03-31T15:05:21', '系统工具目录'),
    (100, '用户管理', 1, 1, '/system/user', '', 'C', '0', '1', 'system:user:view', 'fa fa-user-o', 'admin', '2022-03-31T14:22:06', NULL, NULL, '用户管理菜单'),
    (101, '角色管理', 1, 2, '/system/role', '', 'C', '0', '1', 'system:role:view', 'fa fa-user-secret', 'admin', '2022-03-31T14:22:06', NULL, NULL, '角色管理菜单'),
    (102, '菜单管理', 1, 3, '/system/menu', '', 'C', '0', '1', 'system:menu:view', 'fa fa-th-list', 'admin', '2022-03-31T14:22:06', NULL, NULL, '菜单管理菜单'),
    (103, '部门管理', 1, 4, '/system/dept', '', 'C', '0', '1', 'system:dept:view', 'fa fa-outdent', 'admin', '2022-03-31T14:22:06', NULL, NULL, '部门管理菜单'),
    (104, '岗位管理', 1, 5, '/system/post', '', 'C', '0', '1', 'system:post:view', 'fa fa-address-card-o', 'admin', '2022-03-31T14:22:06', NULL, NULL, '岗位管理菜单'),
    (116, '系统接口', 3, 3, '/tool/swagger', '', 'C', '0', '1', 'tool:swagger:view', 'fa fa-gg', 'admin', '2022-03-31T14:22:06', NULL, NULL, '系统接口菜单'),
    (1000, '用户查询', 100, 1, '#', '', 'F', '0', '1', 'system:user:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1001, '用户新增', 100, 2, '#', '', 'F', '0', '1', 'system:user:add', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1002, '用户修改', 100, 3, '#', '', 'F', '0', '1', 'system:user:edit', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1003, '用户删除', 100, 4, '#', '', 'F', '0', '1', 'system:user:remove', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1004, '用户导出', 100, 5, '#', '', 'F', '0', '1', 'system:user:export', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1005, '用户导入', 100, 6, '#', '', 'F', '0', '1', 'system:user:import', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1006, '重置密码', 100, 7, '#', '', 'F', '0', '1', 'system:user:resetPwd', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1007, '角色查询', 101, 1, '#', '', 'F', '0', '1', 'system:role:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1008, '角色新增', 101, 2, '#', '', 'F', '0', '1', 'system:role:add', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1009, '角色修改', 101, 3, '#', '', 'F', '0', '1', 'system:role:edit', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1010, '角色删除', 101, 4, '#', '', 'F', '0', '1', 'system:role:remove', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1011, '角色导出', 101, 5, '#', '', 'F', '0', '1', 'system:role:export', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1012, '菜单查询', 102, 1, '#', '', 'F', '0', '1', 'system:menu:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1013, '菜单新增', 102, 2, '#', '', 'F', '0', '1', 'system:menu:add', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1014, '菜单修改', 102, 3, '#', '', 'F', '0', '1', 'system:menu:edit', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1015, '菜单删除', 102, 4, '#', '', 'F', '0', '1', 'system:menu:remove', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1016, '部门查询', 103, 1, '#', '', 'F', '0', '1', 'system:dept:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1017, '部门新增', 103, 2, '#', '', 'F', '0', '1', 'system:dept:add', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1018, '部门修改', 103, 3, '#', '', 'F', '0', '1', 'system:dept:edit', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1019, '部门删除', 103, 4, '#', '', 'F', '0', '1', 'system:dept:remove', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1020, '岗位查询', 104, 1, '#', '', 'F', '0', '1', 'system:post:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1021, '岗位新增', 104, 2, '#', '', 'F', '0', '1', 'system:post:add', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1022, '岗位修改', 104, 3, '#', '', 'F', '0', '1', 'system:post:edit', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1023, '岗位删除', 104, 4, '#', '', 'F', '0', '1', 'system:post:remove', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1024, '岗位导出', 104, 5, '#', '', 'F', '0', '1', 'system:post:export', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1039, '操作查询', 116, 1, '#', '', 'F', '0', '1', 'monitor:operlog:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1040, '操作删除', 116, 2, '#', '', 'F', '0', '1', 'monitor:operlog:remove', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1041, '详细信息', 116, 3, '#', '', 'F', '0', '1', 'monitor:operlog:detail', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1042, '日志导出', 116, 4, '#', '', 'F', '0', '1', 'monitor:operlog:export', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1043, '登录查询', 116, 5, '#', '', 'F', '0', '1', 'monitor:logininfor:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1044, '登录删除', 116, 6, '#', '', 'F', '0', '1', 'monitor:logininfor:remove', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1045, '日志导出', 116, 7, '#', '', 'F', '0', '1', 'monitor:logininfor:export', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1046, '账户解锁', 116, 8, '#', '', 'F', '0', '1', 'monitor:logininfor:unlock', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1047, '在线查询', 116, 9, '#', '', 'F', '0', '1', 'monitor:online:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1048, '批量强退', 116, 10, '#', '', 'F', '0', '1', 'monitor:online:batchForceLogout', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1049, '单条强退', 116, 11, '#', '', 'F', '0', '1', 'monitor:online:forceLogout', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1050, '任务查询', 116, 12, '#', '', 'F', '0', '1', 'monitor:job:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1051, '任务新增', 116, 13, '#', '', 'F', '0', '1', 'monitor:job:add', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1052, '任务修改', 116, 14, '#', '', 'F', '0', '1', 'monitor:job:edit', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1053, '任务删除', 116, 15, '#', '', 'F', '0', '1', 'monitor:job:remove', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1054, '状态修改', 116, 16, '#', '', 'F', '0', '1', 'monitor:job:changeStatus', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1055, '任务详细', 116, 17, '#', '', 'F', '0', '1', 'monitor:job:detail', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1056, '任务导出', 116, 18, '#', '', 'F', '0', '1', 'monitor:job:export', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1057, '生成查询', 116, 19, '#', '', 'F', '0', '1', 'tool:gen:list', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1058, '生成修改', 116, 20, '#', '', 'F', '0', '1', 'tool:gen:edit', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1059, '生成删除', 116, 21, '#', '', 'F', '0', '1', 'tool:gen:remove', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1060, '预览代码', 116, 22, '#', '', 'F', '0', '1', 'tool:gen:preview', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (1061, '生成代码', 116, 23, '#', '', 'F', '0', '1', 'tool:gen:code', '#', 'admin', '2022-03-31T14:22:06', NULL, NULL, ''),
    (2000, '功能表', 2000, 1, '#', 'menuItem', 'M', '0', '1', '', 'fa fa-bank', 'admin', '2022-03-31T15:02:44', 'admin', '2022-03-31T15:05:58', ''),
    (2001, '待办任务', 2001, 2, '#', 'menuItem', 'M', '0', '1', '', 'fa fa-bell-o', 'admin', '2022-03-31T15:04:15', 'admin', '2022-03-31T15:06:02', ''),
    (2002, '流程管理', 2002, 0, '#', 'menuItem', 'M', '0', '1', '', 'fa fa-balance-scale', 'admin', '2022-03-31T15:10:38', 'admin', '2022-04-01T11:06:44', ''),
    (2003, '部署管理', 2003, 2, '/flow/manage', 'menuItem', 'C', '0', '1', '', 'fa fa-birthday-cake', 'admin', '2022-04-01T09:30:03', 'admin', '2022-04-02T08:45:49', ''),
    (2004, '模型管理', 2003, 1, '/model/manage', 'menuItem', 'C', '0', '1', '', 'fa fa-glass', 'admin', '2022-04-01T11:00:23', 'admin', '2022-05-27T09:57:51', ''),
    (2005, '请假申请', 2000, 1, '/leaveapply', 'menuItem', 'C', '0', '1', '', '#', 'admin', '2022-04-02T08:43:27', 'admin', '2022-04-02T14:25:38', ''),
    (2006, '我的待办', 2001, 1, '/task/manage/mytask', 'menuItem', 'C', '0', '1', '', '#', 'admin', '2022-04-02T08:44:00', 'admin', '2022-04-13T14:10:52', ''),
    (2007, '全部待办', 2001, 2, '/task/manage/alltasks', 'menuItem', 'C', '0', '1', '', '#', 'admin', '2022-04-02T08:44:24', 'admin', '2022-04-29T11:08:52', ''),
    (2008, '采购申请', 2000, 2, '/purchase', 'menuItem', 'C', '0', '1', '', '#', 'admin', '2022-05-28T10:39:32', 'admin', '2022-05-28T10:39:40', ''),
    (2012, '采购申请', 2000, 2, '/purchase', 'menuItem', 'C', '0', '1', NULL, '#', 'admin', '2022-05-28T10:39:32', NULL, NULL, ''),
    (2013, '发起会议', 2000, 3, '/meeting', 'menuItem', 'C', '0', '1', NULL, '#', 'admin', '2022-05-30T16:49:20', NULL, NULL, '');
...
VALUES
    (1, 'ceo', '董事长', 1, '0', 'admin', '2022-05-26T15:25:37', NULL, NULL, NULL),
    (2, 'se', '项目经理', 2, '0', 'admin', '2022-05-26T15:25:37', NULL, NULL, NULL),
    (3, 'hr', '人力资源', 3, '0', 'admin', '2022-05-26T15:25:37', NULL, NULL, NULL),
    (4, 'user', '普通员工', 4, '0', 'admin', '2022-05-26T15:25:37', NULL, NULL, NULL);
...
VALUES
(1, '超级管理员', 'admin', 1, '1', '0', '0', 'admin', '2022-05-26 15:25:37', null, null, '超级管理员'),
(2, '普通角色', 'common', 2, '2', '0', '0', 'admin', '2022-05-26 15:25:37', 'admin', '2022-06-17 15:40:00', '普通角色'),
(3, '人事', 'HR', 3, '1', '0', '0', 'admin', '2024-03-20 23:33:57', null, null, null);
GO
...
VALUES
(1, 103, 'admin', '流程', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2024-03-20 23:48:17', '2022-05-26 15:25:37', 'admin', '2022-05-26 15:25:37', null, '2024-03-20 23:48:16', '管理员'),
(2, 105, 'ry', '流程曼', '00', 'ry@qq.com', '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', '2022-06-17 15:40:09', '2022-05-26 15:25:37', 'admin', '2022-05-26 15:25:37', 'admin', '2022-06-17 15:40:08', '测试员'),
(3, 103, 'kobe', '科比', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2024-03-20 23:14:25', '2022-05-26 15:25:37', 'admin', '2022-05-26 15:25:37', null, '2024-03-20 23:14:25', '管理员');
GO
